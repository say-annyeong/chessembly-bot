...
impl<'a> Behavior<'a> {
    ...
    pub fn from_str(fragment: &'a str) -> Behavior<'a> {
        ...
        match cmd {
            ...
            "piece" => Behavior::Piece(
                params_vec
                    .get(0)
                    .map(|s| String::from(*s))
                    .unwrap_or(String::new()),
            ),
            "set-state" => Behavior::SetState((
            ...
            "edge-bottom" => Behavior::EdgeBottom((
                params_vec
                    .get(0)
                    .map(|s| s.parse::<i8>().unwrap_or(0))
                    .unwrap_or(0),
            ...
            "corner-top-left" => Behavior::CornerTopLeft((
                params_vec
                    .get(0)
                    .map(|s| s.parse::<i8>().unwrap_or(0))
                    .unwrap_or(0),
            ...
            "corner-top-right" => Behavior::CornerTopRight((
                params_vec
                    .get(0)
                    .map(|s| s.parse::<i8>().unwrap_or(0))
                    .unwrap_or(0),
            ...
            "corner-bottom-left" => Behavior::CornerBottomLeft((
                params_vec
                    .get(0)
                    .map(|s| s.parse::<i8>().unwrap_or(0))
                    .unwrap_or(0),
            ...
            "corner-bottom-right" => Behavior::CornerBottomRight((
                params_vec
                    .get(0)
                    .map(|s| s.parse::<i8>().unwrap_or(0))
                    .unwrap_or(0),
